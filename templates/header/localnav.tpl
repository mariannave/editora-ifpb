...
{capture assign="publicMenu"}
	{if $currentPress}
		{if $enableAnnouncements}
			<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="announcement"}"><{translate key="announcement.announcements"}</a></li>
		{/if}
		<li class="item"><a href="#">{translate key="navigation.about"}</a>
			<ul>
				...
				{if not empty($contextInfo.editorialPolicies)}
					<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="about" op="editorialPolicies"}">{translate key="about.policies"}</a></li>
				{/if}
				...
				{if not empty($contextInfo.sponsorship)}
					<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="about" op="sponsorship"}">{translate key="about.pressSponsorship"}</a></li>
				{/if}
			</ul>
		</li>
	{/if}
...
<div class="pkp_structure_head_localNav">
						...
						<ul class="box">
							...
							<li class="item">
								...
								<ul>
									...
									<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="management" op="settings" path="website"}">{translate key="manager.website"}</a></li>
									<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="management" op="settings" path="publication"}">{translate key="manager.workflow"}</a></li>
									<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="management" op="settings" path="distribution"}">{translate key="manager.distribution"}</a></li>
	...
	{else}{* !$isUserLoggedIn *}
		<ul class="box">
			<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="index"}">{translate key="navigation.home"}</a></li>
			<li class="item"><a href="{url router=$smarty.const.ROUTE_PAGE page="catalog"}">{translate key="navigation.catalog"}</a>
			{$publicMenu}
		</ul>
	{/if}{* $isUserLoggedIn *}
